...
const staggerContainer = {
  ...
  visible: {
    opacity: 1,
    transition: {
      staggerChildren: 0.2, // ১টার পর আরেকটা আসবে
    },
  },
};
    ...
    <div className="bg-base-100 min-h-screen overflow-x-hidden">
      ...
      <div className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <motion.div
          ...
          initial={{ scale: 1.2 }}
          animate={{ scale: 1 }}
          transition={{ duration: 10, ease: "linear" }} // Slow Zoom Out
        ></motion.div>
        <div className="absolute inset-0 bg-gradient-to-b from-black/80 to-base-100 z-10"></div>
        ...
        <div className="relative z-20 text-center max-w-4xl px-6">
          <motion.span
            ...
            initial="hidden"
            animate="visible"
            className="inline-block py-1 px-3 rounded-full bg-blue-500/20 text-blue-400 font-bold tracking-widest uppercase text-xs mb-4 border border-blue-500/30"
          >
            Since 2024
          </motion.span>
          <motion.h1
          ...
          >
            AssetVerse is more than just a tool. It's a complete ecosystem
            designed to bring clarity to your inventory chaos.
          </motion.p>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <p className="text-base-content/70 text-lg leading-relaxed">
              Thus, <strong>AssetVerse</strong> was born. We combined modern
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center gap-2 font-medium text-base-content/80"
                >
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-10 -right-10 w-40 h-40 bg-blue-600/20 rounded-full blur-3xl -z-0"
            ></motion.div>
            <motion.div
              animate={{ y: [0, 20, 0], x: [0, -10, 0] }}
              transition={{ repeat: Infinity, duration: 7, ease: "easeInOut" }}
              className="absolute -top-10 -left-10 w-40 h-40 bg-violet-600/20 rounded-full blur-3xl -z-0"
            ></motion.div>
          </motion.div>
        </div>
      </section>
          ...
          >
            {values.map((item, idx) => (
              <motion.div
                ...
                className="bg-base-100 p-8 rounded-2xl shadow-lg border-t-4 border-blue-600"
              >
                <div className="w-14 h-14 bg-blue-100 dark:bg-blue-900/30 text-blue-600 rounded-xl flex items-center justify-center text-2xl mb-6">
                  {item.icon}
                </div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 lg:px-16">
        <div className="text-center mb-16">
          ...
          <p className="text-base-content/60">
            The passionate people behind AssetVerse.
          </p>
        </div>
        ...
        >
          {teamMembers.map((member, idx) => (
            <motion.div
              key={idx}
              variants={fadeInUp}
              className="group bg-base-100 rounded-2xl shadow-xl overflow-hidden border border-base-200"
            >
              <div className="relative overflow-hidden h-64">
                ...
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4 text-white">
                  <motion.a
                    ...
                    href="#"
                    className="p-2 bg-white/20 rounded-full hover:bg-blue-600 transition-colors"
                  >
                    <FaLinkedinIn />
                  </motion.a>
                  <motion.a
                    whileHover={{ scale: 1.2 }}
                    href="#"
                    className="p-2 bg-white/20 rounded-full hover:bg-blue-400 transition-colors"
                  >
                    <FaTwitter />
                  </motion.a>
                  <motion.a
                    whileHover={{ scale: 1.2 }}
                    href="#"
                    className="p-2 bg-white/20 rounded-full hover:bg-pink-600 transition-colors"
                  >
                    <FaGlobe />
                  </motion.a>
                </div>
      ...
      <section className="py-20 px-6">
        <motion.div
          ...
          className="max-w-4xl mx-auto bg-base-200 rounded-3xl p-10 lg:p-16 text-center border border-base-300 shadow-2xl relative overflow-hidden group"
        >
          ...
          <p className="text-lg text-base-content/70 mb-8 max-w-xl mx-auto relative z-10">
            Join thousands of companies using AssetVerse to manage their
            inventory efficiently.
          </p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="btn btn-primary btn-lg rounded-full px-8 bg-gradient-to-r from-blue-600 to-violet-600 border-none text-white shadow-lg hover:shadow-blue-500/40 relative z-10"
          >
            Get Started Today
          </motion.button>
        </motion.div>
